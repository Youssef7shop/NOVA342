...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    function showToast(message) {
        ...
        clearTimeout(window.novaOrdersToast);

        window.novaOrdersToast = setTimeout(() => {
    ...
    async function attachWorkers(orders) {
    ...
    function updateStats() {
        ...
        /*
         * Total spent:
         * Exclude rejected/cancelled orders.
         */
    ...
    async function cancelOrder(
        ...
        try {
             ...
             * IMPORTANT:
             *
             * We no longer update orders directly.
             *
             * Supabase RPC checks:
             * - authenticated user
             * - order ownership
    ...
    function openOrderDetails(
        ...
        window.location.href =
            `order-details.html?order=${encodeURIComponent(
                order.id
            )}`;
    }
